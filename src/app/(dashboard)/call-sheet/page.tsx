...
export default function CallSheetPage() {
    ...
    const exportToExcel = () => {
        try {
            ...
            const success = forceDownloadExcel(workbook, `Report_${selectedDate}.xlsx`);
            if (!success) throw new Error("فشل التحميل التلقائي");
        } catch (error: any) {
        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 no-print pb-4 border-b border-slate-100">
                ...
                <div className="flex flex-wrap items-center gap-4">
                    ...
                    <a
                        href="/dashboard"
                        className="p-3 bg-white border border-border rounded-xl text-slate-400 hover:text-primary transition-all shadow-sm"
                        title="الرئيسية"
                    >
...
// -------------------------------------------------------------
// Official Print Layout Component
// Completely hidden in web view, highly formatted for A4 printing
// -------------------------------------------------------------
