...
export const DEPARTMENTS_MAPPING: DepartmentMapping[] = [
    ...
    { canonicalName: "الأمراض الصدرية", englishName: "Pulmonology", aliases: ["الامراض الصدرية", "الامراض الصدريه", "صدرية", "صدريه", "الامراض الصدرية "] },
    { canonicalName: "بنك الدم", englishName: "Blood Bank", aliases: ["بنك الدم", "بنك الدم ", "قسم بنك الدم"] },
